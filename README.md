...
🎥 **Video Presentation:** [YouTube Link](https://youtu.be/C2dimPPJZk4)
...
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Stress & Workload Manager**        | A system that combines workload tracking, overload detection, decision support, and recovery support.                                     | ✅ **Selected**                               | Directly addresses the problem of students carrying multiple responsibilities without understanding their overall workload.                                                                                                     |
...
| **Overload Risk Analysis**           | Analyses workload and user information to identify when the user's workload may become excessive.                                         | 🔄 **Refined**                               | The original idea was retained but simplified into a more direct **Too Busy Warning** based on the user's planned capacity and workload usage.                                                                                  |
| **Load Balancer**                    | Suggests which commitments should be completed, delayed, reduced, or treated as optional when workload becomes too high.                  | ❌ **Dropped / Replaced**                     | Automatically rebalancing existing commitments would require more user input and increase implementation complexity. The idea was replaced with more practical interventions such as **Reply Helper** and **Too Busy Warning**. |
| **"What If?" Simulator**             | Allows users to test how adding a new commitment would affect their overall workload.                                                     | 🔄 **Refined**                               | The underlying idea was retained, but instead of creating a separate simulator, it was integrated directly into **Check Before Adding**, allowing users to see the impact of a commitment before accepting it.                  |
| **Recovery Recommendations**         | Suggests recovery activities when workload becomes high, such as taking breaks, sleeping, exercising, or spending time away from screens. | 🔄 **Refined**                               | The recovery concept was kept but narrowed into a simpler **Time for a Break** intervention that recommends short and realistic recovery activities.                                                                            |
| **Weekly Summary & Trends**          | Shows changes in workload over time and identifies recurring workload patterns.                                                           | 🔄 **Refined**                               | The idea of workload visibility was retained, but the prototype focuses more on immediate workload awareness and decision-making rather than long-term trend analysis.                                                          |
...
| **Check Before Adding**              | Shows users how a new commitment would affect their **Time Used %** and available break time before it is added.                          | 🔄 **Refined from "What If?" Simulator**     | The team found that workload simulation would be more useful when integrated directly into the process of adding a commitment, making the feature simpler and more practical.                                                   |
| **Reply Helper**                     | Generates polite responses that help users negotiate, decline, or reschedule a commitment when they are already too busy.                 | ✅ **Added / Kept**                           | The team wanted VertexLoad to do more than identify overload. Reply Helper provides an actionable way for students to respond to new commitments and manage their workload.                                                     |
| **Too Busy Warning**                 | Warns users when their workload exceeds their planned capacity or daily guideline.                                                        | 🔄 **Refined from Overload Risk Analysis**   | A clear warning was considered more understandable and actionable for students than a complex risk score.                                                                                                                       |
| **Time for a Break**                 | Suggests a short recovery activity, such as a campus walk or cafe reset, when the user's workload becomes excessive.                      | 🔄 **Refined from Recovery Recommendations** | The team narrowed the recovery feature to simple, realistic interventions that can be acted on immediately.                                                                                                                     |

### From Ideas to VertexLoad

Through this process, the team gradually narrowed the concept from a broad **student well-being and productivity system** into a more focused workload decision system.

Several original ideas were either dropped or refined to improve **clarity, usability, technical feasibility, and scope**:

**AI Personal Assistant**
→ **Conversational AI Workload Input**
...
**Load Balancer**
→ **Dropped / Replaced by actionable interventions such as Reply Helper**

The final direction became **VertexLoad**, focusing on helping students **understand their capacity, evaluate commitments before saying yes, recognise overload early, and take action before it develops into burnout.**
...
| **8/9/2026** | **Daniel Koh Yu Hang**   |        **6** | **Review the Problem Tree and Mind Map**<br>• Review whether the **Problem Tree** and **Mind Map** clearly represent the project's problem and its related factors.<br>• Explore further how the identified factors and responsibilities can eventually lead to **workload overloading**.<br>• Ensure the relationship between the root causes, workload accumulation, and the main problem is clear. | • Refined the **Problem Tree** and **Mind Map** to better explain how multiple responsibilities and commitments can accumulate and lead to workload overload. |
| **8/9/2026** | **Daniel Koh Yu Hang**   |        **7** | **Explore how AI understands and interprets the problem**<br>• Consider how the AI interprets the user's input and identifies the relevant workload information.<br>• Explore how the AI can understand questions or descriptions related to the user's workload.<br>• The system should be able to handle different ways users may describe their workload. | • Further refined the **Conversational AI Workload Input** concept to support different forms of user input and workload descriptions. |
| **8/9/2026** | **Daniel Koh Yu Hang**   |        **8** | **Include additional scenarios to showcase AI transparency**<br>• Consider scenarios where users provide **incomplete or unclear requirements**.<br>• Show how the AI interprets the available information and identifies what may be missing.<br>• This can demonstrate how the system handles uncertainty instead of silently making assumptions. | • Improved the AI transparency approach by considering **incomplete or unclear user input**, including showing the information extracted and identifying areas that may require clarification. |
| **8/9/2026** | **Daniel Koh Yu Hang**   |        **9** | **Determine whether a database is necessary based on the data being stored**<br>• Consider whether the application actually requires a database.<br>• The decision should depend on **what information needs to be stored and persisted**.<br>• Review whether the project's current requirements justify the use of a database. | • Reviewed the database requirement and decided **not to use a database**, as the application can store the required data **locally on the user's device** without requiring server-side persistent storage. || **8/9/2026** | **Daniel Koh Yu Hang**   |       **10** | **Ensure the user flow is clear and intuitive**<br>• Review whether the overall **user flow** is clear from the user's perspective.<br>• Consider whether a first-time user can understand and use the application **without additional guidance**.<br>• Reduce unnecessary steps and make the main workflow easy to follow. | • Reviewed and refined the **User Flow** to keep the core workflow clear and intuitive, from setting up workload information through checking workload impact and receiving decision support. |
| **8/9/2026** | **Daniel Koh Yu Hang**   |       **11** | **Strengthen the presentation around the problem and pain points**<br>• The presentation should clearly explain the **problem and user pain points** before introducing the solution.<br>• Consider including the consultation **recording** where appropriate as supporting evidence.<br>• The demonstration should focus more on the actual prototype and how it addresses the identified problem. | • Refined the presentation structure to emphasise the **problem and pain points** before demonstrating the prototype, with the consultation recording considered as supporting evidence. |
| **8/9/2026** | **Daniel Koh Yu Hang**   |       **12** | **Focus the demo on the prototype and clickable UI**<br>• The demonstration should focus more on the **prototype** rather than only explaining the concept.<br>• Show how users interact with the clickable interface.<br>• Demonstrate practical interactions such as **adding workload or commitment data** and seeing how the system responds. | • Refined the demo to focus on the **clickable prototype**, including adding commitment data, previewing its workload impact, and demonstrating the resulting decision-support workflow. |
| **8/9/2026** | **Daniel Koh Yu Hang**   |       **13** | **Explore further options before finalising the entire solution**<br>• Consider additional options or features before completely finalising the solution.<br>• However, the team should consider the remaining development time.<br>• Additional features should only be included if there is sufficient time to implement them without affecting the core solution. | • Reviewed additional feature possibilities against the remaining development time and prioritised the **core MVP**, adding further features only when they can be completed without affecting overall stability and completeness. |
| **8/9/2026** | **Daniel Koh Yu Hang**   |       **14** | **Make the presentation and interface more engaging**<br>• Consider starting from a smaller, more engaging element to capture the user's attention.<br>• Possible approaches include using a **chart, mascot, visual message, or interactive element**.<br>• The engaging element should support the main problem and user experience rather than becoming an unnecessary feature. | • Explored lightweight interactive elements such as a **workload chart, mascot, or interactive visual opening** to make the presentation and user experience more engaging while keeping the focus on the core problem. |
